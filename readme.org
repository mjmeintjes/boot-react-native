...
NOTE: please refer to the [[https://github.com/mjmeintjes/boot-react-native/blob/master/changelog.md][changelog]] for notes update how to upgrade to boot-react-native 0.3.
